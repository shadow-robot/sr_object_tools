...
// Utilities includes
#include <utilities/graph/graph_weighted.hpp>
...
////////////////////////////////////////////////////////////////////////////////
bool addEdge(Traits::vertex_descriptor& v1, Traits::vertex_descriptor& v2, GraphBoost& graph, const float weight,
             CapacityMap& capacity_map, ReverseEdgeMap& reverse_edge_map)
{
              ...
              std::vector<int>& sink_points)
{
  ...
  {
    std::cout << "[utl::minCut] number of vertices in source potentials, sink potentials and binary potentials are not "
                 "equal."
              << std::endl;
    return -1.0;
  }
